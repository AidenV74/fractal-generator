...
def apply_rules(axiom, char_1, rule_1, char_2, rule_2, char_3, rule_3, char_4, rule_4, char_5, rule_5):
   return "".join(
       [
           rule_1 if char == char_1 else rule_2 if char == char_2 else rule_3 if char == char_3 else rule_4 if char == char_4 else rule_5 if char == char_5 else char
           for char in axiom
       ]
   )
...
def get_result(iterations, axiom, char_1, rule_1, char_2, rule_2, char_3, rule_3, char_4, rule_4, char_5, rule_5):
   for gen in range(iterations):
       axiom = apply_rules(axiom, char_1, rule_1, char_2, rule_2, char_3, rule_3, char_4, rule_4, char_5, rule_5)
   return axiom
...
def interpret_movement(axiom, char_1, char_2, char_3, char_4, char_5, angle, length, color):
   global resize_flag, current_angle
   ...
   for char in axiom:
       ...
       if char == "+":
           ...
           stack.append(((x, y), (new_x, new_y), (current_angle), (length)))
       elif char == "]":
           (x, y), (new_x, new_y), current_angle, length = stack.pop(-1)
       elif char == ">":
           length = length / 1.36
       if draw == True:
...
def draw_main():
   ...
   global resize_flag, LENGTH_MULTIPLIER, current_angle
   ...
   char_4, rule_4 = fractal_info[fractal]["char_4"], fractal_info[fractal]["rule_4"]
   char_5, rule_5 = fractal_info[fractal]["char_5"], fractal_info[fractal]["rule_5"]
   current_angle = fractal_info[fractal]["starting_angle"]
   ...
   if mode == "Multiple Iterations":
       for i in range(1, iterations + 1):
           ...
           axiom = apply_rules(axiom, char_1, rule_1, char_2, rule_2, char_3, rule_3, char_4, rule_4, char_5, rule_5)
           interpret_movement(axiom, char_1, char_2, char_3, char_4, char_5, angle, length, color)
   ...
   # Single iteration mode
       ...
       axiom = get_result(iterations, axiom, char_1, rule_1, char_2, rule_2, char_3, rule_3, char_4, rule_4, char_5, rule_5)
       interpret_movement(axiom, char_1, char_2, char_3, char_4, char_5, angle, length, color)
...
fractal_info = {
   ...
   "Pentaplexity": {
      ...
      "char_5": "",
      "rule_5": "",
      "starting_pos": (1 / 4 * WIDTH, 1 / 5 * HEIGHT),
      "starting_angle": 0,
  },
   "Crystal": {
      "color": "yellow",
   ...
   "Bush 1": {
      ...
      "char_5": "",
      "rule_5": "",
      "starting_pos": (1 / 2 * WIDTH, 9 / 10 * HEIGHT),
...
pg.display.set_caption("Aiden's Master Fractal Generator v2.5")
